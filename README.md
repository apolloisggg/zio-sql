...
```scala
//PostgreSQL
libraryDependencies += "dev.zio" %% "zio-sql-postgres" % "0.0.2" 

//MySQL
libraryDependencies += "dev.zio" %% "zio-sql-mysql" % "0.0.2"

//Oracle
libraryDependencies += "dev.zio" %% "zio-sql-oracle" % "0.0.2"

//SQL Server
libraryDependencies += "dev.zio" %% "zio-sql-sqlserver" % "0.0.2"
```
